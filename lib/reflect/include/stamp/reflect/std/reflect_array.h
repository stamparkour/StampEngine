...
namespace stamp::reflect {
	...
	struct reflect_traits<std::array<T, N>> {
		...
		static constexpr string_literal name = concat_cstring_v<"array<", traits::name_v<T>, ",", integral_to_string_literal_v<std::size_t, N>, ">">;
		static constexpr string_literal basic_name = "array";
		static constexpr string_literal full_name = concat_cstring_v<"std::array<",traits::full_name_v<T>,",", integral_to_string_literal_v<std::size_t, N>,">">;

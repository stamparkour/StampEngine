...
game_component::AudioSourceEffect::AudioSourceEffect(xptr<game_core::AudioClip> clip, bool autoDelete, bool startPlaying) noexcept {
	this->clip = clip;
	this->autoDelete = autoDelete;
	if(startPlaying) this->clip->Play(1);
}
void game_component::AudioSourceEffect::PlayClip(xptr<game_core::AudioClip> clip) {
